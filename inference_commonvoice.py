...
ds = load_dataset("masuidrive/cv-corpus-17.0-zh-TW-client_id-grouped", split="train", streaming=True)
# print(next(iter(ds)))
...
# Display results
for i, (transcription, original_text) in enumerate(zip(transcriptions, batch["sentence"]), 1):
    print(f"\n Sample {i}:")
