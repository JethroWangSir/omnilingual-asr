...
ds = load_dataset("PolyAI/minds14", "zh-CN", split="train", streaming=True)
# print(next(iter(ds)))
...
# Display results
for i, (transcription, original_text) in enumerate(zip(transcriptions, batch["transcription"]), 1):
    print(f"\n Sample {i}:")
